  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      if (captureMode === 'photo' && preview) {
        // TODO: E2E encrypt image before upload via Web Crypto API
        // For now, send base64 directly to captures endpoint
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-lg px-4 py-8">
        ...
        <div className="mt-6">
          {captureMode === 'photo' ? (
            <div className="space-y-4">
              {/* Camera input (mobile opens camera, desktop opens file picker) */}
              <input
                ref={fileRef}
                type="file"
                accept="image/*"
              ...
              {preview && (
                <div className="relative">
                  ...
                  <img src={preview} alt="Capture preview" className="w-full rounded-lg" />
                  <button
            ...
            <textarea
              ...
              placeholder="Type a quick note about a contact, meeting, or idea..."
              rows={6}
        ...
        >
          {uploading ? 'Processing...' : captureMode === 'photo' ? 'Capture & Process' : 'Save Note'}
        </button>
