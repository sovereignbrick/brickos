  ...
  if (message.role === 'user') {
    return (
      <div className="flex justify-end px-4 py-1">
        <div
          className="max-w-[80%] px-4 py-3 rounded-2xl rounded-tr-sm text-sm text-foreground/90"
          style={{
  ...
  return (
    <div className="flex justify-start px-4 py-1">
      <div className="flex gap-2 max-w-[85%]">
        ...
        <div
          className="rounded-2xl rounded-tl-sm text-sm text-foreground/85 border-l-2 border-teal-500/40 pl-4 pr-4 py-3"
          style={{
        ...
        >
          <ReactMarkdown
            ...
            components={{
              ...
              h4: ({ children }) => (
                <h4 className="text-sm font-semibold text-foreground/90 mt-2 mb-1">{children}</h4>
              ),
              p: ({ children }) => <p className="mb-2 last:mb-0 leading-relaxed">{children}</p>,
              ul: ({ children }) => <ul className="list-disc ml-4 mb-2 space-y-1">{children}</ul>,
              ol: ({ children }) => <ol className="list-decimal ml-4 mb-2 space-y-1">{children}</ol>,
              li: ({ children }) => <li className="leading-relaxed">{children}</li>,
              code: ({ children }) => <code className="bg-accent px-1 rounded text-sm font-mono">{children}</code>,
