      ...
      {tab === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="rounded-2xl border border-zinc-800 p-5 space-y-3">
            ...
            {/* Sprint 048 #048-51: patient consent breakdown. Lives outside the
                license conditional so orgs with no active license (staging default)
                still show consent state. Only renders when there are members. */}
